...
# LDAP
####################################
LDAP_SERVER_ADDRESS = os.environ.get("LDAP_SERVER_ADDRESS", "").strip('"')
LDAP_SERVER_PORT = os.environ.get("LDAP_SERVER_PORT", "").strip('"')
BIND_DN = os.environ.get("BIND_DN", "").strip('"')
BIND_PW = os.environ.get("BIND_PW", "").strip('"')
USER_SERACH_BASE = os.environ.get("USER_SERACH_BASE", "").strip('"')
USER_SEARCH_FILTER = os.environ.get("USER_SEARCH_FILTER", "").strip('"')
ADMIN_SEARCH_FILTER = os.environ.get("ADMIN_SEARCH_FILTER", "").strip('"')
GROUP_SEARCH_FILTER = os.environ.get("GROUP_SEARCH_FILTER", "").strip('"')
USERNAME_ATTRIBUTE = os.environ.get("USERNAME_ATTRIBUTE", "").strip('"')
ACCOUNT_ATTRIBUTE = os.environ.get("ACCOUNT_ATTRIBUTE", "").strip('"')
USER_DOMAIN = os.environ.get("USER_DOMAIN", "").strip('"')
